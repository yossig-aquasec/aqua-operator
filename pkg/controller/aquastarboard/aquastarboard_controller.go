...
func (r *ReconcileAquaStarboard) addKEClusterRoleBinding(cr *v1alpha1.AquaStarboard) (reconcile.Result, error) {
...
func (r *ReconcileAquaStarboard) addKEConfigMap(cr *v1alpha1.AquaStarboard) (reconcile.Result, error) {
...
func (r *ReconcileAquaStarboard) addKESecret(cr *v1alpha1.AquaStarboard) (reconcile.Result, error) {
