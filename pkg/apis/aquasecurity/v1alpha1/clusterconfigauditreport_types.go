...
// ClusterConfigAuditReportSpec defines the desired state of ClusterConfigAuditReport
type ClusterConfigAuditReportSpec struct {
...
// ClusterConfigAuditReportStatus defines the observed state of ClusterConfigAuditReport
type ClusterConfigAuditReportStatus struct {
...
type ClusterConfigAuditReport struct {
	...
	Spec   ClusterConfigAuditReportSpec   `json:"spec,omitempty"`
	Status ClusterConfigAuditReportStatus `json:"status,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// ClusterConfigAuditReportList contains a list of ClusterConfigAuditReport
...
func init() {
	SchemeBuilder.Register(&ClusterConfigAuditReport{}, &ClusterConfigAuditReportList{})
}
